...
import { eventClearActiveEvt, eventStartAddNew, eventStartUpdated } from '../../actions/events';
...
const later = now.clone().add(1, 'hours');//new Date(now.valueOf());
const initEvent = {
    title: '',
    notes: '',
    start: now.toDate(),
    end: later.toDate(),
    user: { _id: 123, name: 'Cristhian' },
}
...
export const CalendarModal = () => {
    ...
    const handleSubmitForm = (e) => {
        ...
        if (momentStart.isSameOrAfter(momentEnd)) {
            // console.log('Fecha 2 no debe ser mayor');
